...
let result = dice();
console.log("Numero casuale:", result); 
...
let biggerNumber = whoIsBigger(10, 20);
console.log("Il numero più grande è:", biggerNumber);
...
let stringToModify = "Hello World";
let modifiedString1 = deleteOne(stringToModify, true);
let modifiedString2 = deleteOne(stringToModify, false);

console.log(modifiedString1); // Output: "ello World"
console.log(modifiedString2); // Output: "Hello Worl"
...
let stringWithoutNumbers = onlyLetters(stringWithNumbers)
...
function howManyDays(date) {
  var today = new Date();
  var differenceInMillis = today - date;
  var daysPassed = Math.floor(differenceInMillis / (1000 * 60 * 60 * 24))
  return daysPassed;
}
var startDate = new Date("2024-01-21"); // Data di partenza 
var daysPassed = howManyDays(startDate);
console.log("Sono passati", daysPassed, "giorni da", startDate, "fino ad oggi.")
...
var myBirthday = new Date("2024-12-01") 
...
function addNewElementToList() {
  let newItem = document.createElement("li")
    let textNode = document.createTextNode("Giovedi")
